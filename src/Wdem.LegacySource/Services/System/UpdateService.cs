...
{
  /// <summary>Checks for and applies Wdem.LegacySource self-updates by downloading the latest GitHub release and performing an atomic self-replacement with rollback.</summary>
  public class UpdateService : IUpdateService
  {
    ...
    public UpdateService(ILogger logger, IHostApplicationLifetime lifetime, HttpClient? httpClient = null)
    {
      ...
      {
        _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Wdem.LegacySource-CLI");
      }
    }
