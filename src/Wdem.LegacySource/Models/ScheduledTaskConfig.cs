...
namespace Wdem.LegacySource.Models
{
  ...
  public class ScheduledTaskConfig : ResourceBase
  {
    ...
    /// <summary>Optional Task Scheduler folder path (e.g., "\Wdem.LegacySource"). Combined with <see cref="Name"/> to form the full registration path. Leave empty to register at the root folder.</summary>
