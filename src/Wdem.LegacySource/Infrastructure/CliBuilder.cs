...
/// <summary>Builds the System.CommandLine root command and all subcommands for the Wdem.LegacySource CLI.</summary>
public static class CliBuilder
{
    ...
    Func<string, string?, string?, LogLevel, Task<int>>? configAction = null)
  {
    ...
    stateCommand.Description = "Manage the system state managed by Wdem.LegacySource";
    ...
    listSubCommand.Description = "List all items currently managed by Wdem.LegacySource";
