...
namespace Wdem.LegacySource.Tests
{
  public class PluginSystemTests
  {
    ...
    {
      // Arrange
      var tempDir = Path.Combine(Path.GetTempPath(), "Wdem.LegacySourceTests", Guid.NewGuid().ToString());
...
";
      ...
      var uvBootstrapper = new Wdem.LegacySource.Services.Bootstrappers.UvBootstrapper(mockProcessRunner.Object);
      var bunBootstrapper = new Wdem.LegacySource.Services.Bootstrappers.BunBootstrapper(mockProcessRunner.Object);
