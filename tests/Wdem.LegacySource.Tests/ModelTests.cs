...
";
  ...
  public void ScheduledTaskConfig_ShouldRoundTrip_JsonSerialization()
  {
    ...
    {
      Name = "Daily Cleanup",
      Path = "\\Wdem.LegacySource\\Cleanup",
      Description = "Cleanup temp files",
      Author = "Wdem.LegacySource",
  ...
  public void RegistryTweak_ShouldRoundTrip_YamlSerialization()
  {
    ...
    var original = new RegistryTweak
    {
      Path = "HKLM\\Software\\Wdem.LegacySource",
      Name = "TestString",
      Value = "Enabled",
      Type = "string"
    };
  ...
  public void Configuration_ScheduledTasks_ShouldRoundTrip_Json()
  {
    ...
    Assert.Equal("\\Wdem.LegacySource\\Sync", deserialized.ScheduledTasks[0].Path);
