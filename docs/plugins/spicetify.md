...
This plugin manages the Spicetify configuration file located in the user's profile directory. Settings are merged into the existing `config.ini`, allowing Spicetify customization to be managed declaratively through WDEM.
